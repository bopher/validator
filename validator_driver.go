...
func (v *validatorDriver) proccessStructValidation(locale string, s interface{}, err interface{}) ErrorResponse {
...
func (v *validatorDriver) proccessVarValidation(locale string, params ValidatorParam, messages map[string]string, err interface{}) ErrorResponse {
	res := NewErrorResponse()
	if errors, ok := err.(validator.ValidationErrors); ok {
		for _, e := range errors {
...
func (v *validatorDriver) TranslateStruct(s interface{}, locale string, key string, field string, placeholders map[string]string) string {
	return v.T.TranslateStruct(s, locale, key, field, placeholders)
}

func (v *validatorDriver) StructLocale(locale string, s interface{}) ErrorResponse {
	err := v.V.Struct(s)
	if err != nil {
...
func (v *validatorDriver) StructExceptLocale(locale string, s interface{}, fields ...string) ErrorResponse {
...
func (v *validatorDriver) StructPartialLocale(locale string, s interface{}, fields ...string) ErrorResponse {
...
func (v *validatorDriver) VarLocale(locale string, params ValidatorParam, field interface{}, tag string, messages map[string]string) ErrorResponse {
	if params.Name == "" {
...
func (v *validatorDriver) VarWithValueLocale(locale string, params ValidatorParam, field interface{}, other interface{}, tag string, messages map[string]string) ErrorResponse {
	if params.Name == "" {
		panic("Name field must passed to ValidatorParam")
	}
